...
public class User {
    ...
    static String[][] adminUserNameAndPassword = new String[20][2];
                ...
                if (r1.isPrivilegedUserOrNot(username, password) == -1) {
                    ...
                    do {
                        ...
                        if (desiredOption == 1) {
                            ...
                            c1.displayCustomersData(false);
                            System.out.print("\n\nEnter the ID of the user to dis4play all flights registered by that user...");
    ...
    static void manualInstructions() {
        Scanner read = new Scanner(System.in);
        System.out.printf("%n%n%50s %s Welcome to Airlines User Manual %s", "", "+++++++++++++++++", "+++++++++++++++++");
